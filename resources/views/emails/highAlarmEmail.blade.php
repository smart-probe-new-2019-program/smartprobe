<div>
	Hi,
	<br/><br/>
	One of your connected Probes' temperature is in <font style="color: red;">High Alarm</font> level. Please check the device.
	<br/>
	<h4>Probe Details</h4>
	...
	Reading From Sensor: <b style="color: red;">{{$latest_log->actual_temperature}}&#176; {{$probe->temperature_unit}}</b><br /> 
</div>