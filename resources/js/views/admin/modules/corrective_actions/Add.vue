        ...
        <div class="card">
          <div class="card-header">
            <div class="row">
              ...
              <div class="col-sm-6">
                <router-link to="/admin/corrective_actions" class="btn btn-dark btn-xs float-right">
              ...
              <div class="panel-body">
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <select
                      class="form-control"
                      @change="getNeededDropdowns()"
                      v-model.trim="correctiveActionsData.organization_id"
                      ref="organization_id"
                      required
                    >
                      <option
                ...
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <select
                      class="form-control"
                      v-model.trim="correctiveActionsData.user_id"
                      ref="user_id"
                      required
                    >
                ...
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <select
                      class="form-control"
                      v-model="correctiveActionsData.comment_type"
                      ref="comment_type"
                      required
                    >
                ...
                <div class="row" v-if="correctiveActionsData.comment_type=='Group Comment'">
                  <div class="col-sm-6 form-group">
                    ...
                    <textarea
                      v-model.trim="correctiveActionsData.comment"
                      class="form-control"
                      rows="3"
                      ref="comment"
                    />
                ...
                <div class="row" v-if="correctiveActionsData.comment_type=='Individual Comment'">
                  <div class="col-sm-6 form-group" v-if="probes.length > 0">
                    <div
                      ...
                      :value="individual_comment.probe_id"
                      class="form-group"
                    >
                      <label class="control-label">
                        Comment for:
                        <b>{{individual_comment.probe_name}} - {{individual_comment.probe_serial_number}}</b>
                      </label>
                      <textarea
                        v-model.trim="individual_comment.comment"
                        class="form-control"
                        rows="3"
                        ref="comment"
                      />
...
export default {
  ...
  methods: {
    ...
    getUsersByOrganizationID() {
      ...
      axios
        .get(
          "/api/admin/users/getUsersByOrganizationID/" +
            app.correctiveActionsData.organization_id
        )
        .then(function(resp) {
          app.users = resp.data;
        })
    ...
    getProbesByOrganizationID() {
      ...
      axios
        .get(
          "/api/admin/probes/getProbesByOrganizationID/" +
            app.correctiveActionsData.organization_id
        )
        .then(function(resp) {
    ...
    saveForm() {
      let app = this;
      app.correctiveActionsData.comments = app.individual_comments;

      axios
        .post("/api/admin/corrective_actions", app.correctiveActionsData)
        .then(function(resp) {
          if (resp.data.status == "error") {
            toastr["error"](
              "Something went wrong while adding the corrective actions. Please contact admin about this.",
              "Error!"
            );
          } else {
