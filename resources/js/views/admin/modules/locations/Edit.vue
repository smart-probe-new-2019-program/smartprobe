              ...
              <div class="panel-body">
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <select
                      class="form-control"
                      v-model.trim="locationData.organization_id"
                      ref="organization_id"
                      required
                    >
                      <option
                ...
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <input
                      type="text"
                      v-model.trim="locationData.name"
                      class="form-control"
                      ref="name"
                      required
                    />
                ...
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <input
                      type="text"
                      v-model.trim="locationData.address"
                      class="form-control"
                      ref="address"
                      required
                    />
                ...
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <input
                      type="text"
                      v-model.trim="locationData.state"
                      class="form-control"
                      ref="state"
                    />
                  </div>
                ...
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <input
                      type="text"
                      v-model.trim="locationData.zip_code"
                      class="form-control"
                      ref="zip_code"
                    />
                  </div>
                ...
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <input
                      type="email"
                      v-model.trim="locationData.email"
                      class="form-control"
                      ref="email"
                      required
                    />
                ...
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <input
                      type="text"
                      v-model.trim="locationData.office_phone"
                      class="form-control"
                      ref="office_phone"
                    />
                  </div>
                ...
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <input
                      type="text"
                      v-model.trim="locationData.office_fax"
                      class="form-control"
                      ref="office_fax"
                    />
                  </div>
                ...
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <input
                      type="text"
                      v-model.trim="locationData.mobile_phone"
                      class="form-control"
                      ref="mobile_phone"
                    />
                  </div>
...
export default {
  ...
  methods: {
    getLocation() {
      ...
      axios
        .get("/api/admin/locations/getLocation/" + id)
        .then(function(resp) {
    ...
    saveForm() {
      ...
      axios
        .patch("/api/admin/locations/" + app.locationData.id, app.locationData)
        .then(function(resp) {
          if (resp.data.status == "error") {
            toastr["error"](
              "Something went wrong while updating the location. Please contact admin about this.",
              "Error!"
            );
          } else {
