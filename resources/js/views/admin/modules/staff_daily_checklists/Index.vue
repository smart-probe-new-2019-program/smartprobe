        ...
        <div class="card">
          <div class="card-header">
            <div class="row">
              ...
              <div class="col-sm-6">
                <router-link
                  to="/admin/staff_daily_checklists/add"
              ...
              <div class="col-sm-12 form-group">
                <div class="row">
                  <div class="col-sm-3 form-group">
                    ...
                    <select
                      class="form-control"
                      @change="getStaffDailyChecklists()"
              ...
              >
                ...
                <table-column :sortable="false" :filterable="false" label="Actions">
                  <template slot-scope="row">
                    <a :href="`/admin/staff_daily_checklists/view/${row.id}`">
  ...
  methods: {
    ...
    getStaffDailyChecklists: lodash.debounce(function(page = 1) {
      ...
      if (app.filters.start_date > app.filters.end_date) {
        ...
        axios
          .get(
            `/api/admin/staff_daily_checklists/get?page=${page}&organization_id=${app.filters.organization}&start_date=${app.filters.start_date}&end_date=${app.filters.end_date}`
          )
          .then(function(resp) {
