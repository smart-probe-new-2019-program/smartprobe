            ...
            <form @submit.prevent="saveForm">
              <div class="panel-body">
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <input
                      type="text"
                      v-model.trim="probeData.serial_number"
                      class="form-control"
                      ref="serial_number"
                      required
                    />
                ...
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <select
                      class="form-control"
                      v-model="probeData.cooling_device"
                      ref="cooling_device"
                      required
                    >
                      ...
                      <option
                        value="Lairage Liquid Chlorine Chiller"
                      >Lairage Liquid Chlorine Chiller</option>
                ...
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <select
                      class="form-control"
                      v-model="probeData.temperature_unit"
                      ref="temperature_unit"
                      required
                    >
                ...
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <input
                      type="text"
                      v-model.trim="probeData.temperature_warning_high"
                      class="form-control"
                ...
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <input
                      type="text"
                      v-model.trim="probeData.temperature_warning_low"
                      class="form-control"
                ...
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <input
                      type="text"
                      v-model.trim="probeData.temperature_alert_high"
                      class="form-control"
                      ref="temperature_alert_high"
                      required
                    />
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <input
                      type="text"
                      v-model.trim="probeData.temperature_alert_low"
                      class="form-control"
                      ref="temperature_alert_low"
                      required
                    />
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <input
                      type="text"
                      v-model.trim="probeData.minimum_voltage"
                      class="form-control"
                      ref="minimum_voltage"
                      required
                    />
                ...
                <div class="row" v-if="probeData.probe_type=='Humidity Probe'">
                  <div class="col-sm-6 form-group">
                    ...
                    <input
                      type="text"
                      v-model.trim="probeData.humidity_warning_high"
                      class="form-control"
                      ref="humidity_warning_high"
                    />
                  </div>
                </div>
                <div class="row" v-if="probeData.probe_type=='Humidity Probe'">
                  <div class="col-sm-6 form-group">
                    ...
                    <input
                      type="text"
                      v-model.trim="probeData.humidity_warning_low"
                      class="form-control"
                      ref="humidity_warning_low"
                    />
                  </div>
                </div>
                <div class="row" v-if="probeData.probe_type=='Humidity Probe'">
                  <div class="col-sm-6 form-group">
                    ...
                    <input
                      type="text"
                      v-model.trim="probeData.humidity_alert_high"
                      class="form-control"
                      ref="humidity_alert_high"
                    />
                  </div>
                </div>
                <div class="row" v-if="probeData.probe_type=='Humidity Probe'">
                  <div class="col-sm-6 form-group">
                    ...
                    <input
                      type="text"
                      v-model.trim="probeData.humidity_alert_low"
                      class="form-control"
                      ref="humidity_alert_low"
                    />
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <datepicker
                      v-model="probeData.next_calibration_date"
                      :format="format"
                      input-class="form-control"
                      ref="next_calibration_date"
                    />
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-4 form-group">
                    ...
                    <input
                      type="text"
                      v-model.trim="probeData.frequency_to_check_temperatures_value"
                      class="form-control"
                      ref="frequency_to_check_temperatures_value"
                    />
                  </div>
                  <div class="col-sm-2 form-group">
                    ...
                    <select
                      class="form-control"
                      v-model="probeData.frequency_to_check_temperatures_unit"
                      ref="frequency_to_check_temperatures_unit"
                      required
                    >
                ...
                <div class="row">
                  <div class="col-sm-4 form-group">
                    ...
                    <input
                      type="text"
                      v-model.trim="probeData.alarm_time_value"
                      class="form-control"
                      ref="alarm_time_value"
                    />
                  </div>
                  <div class="col-sm-2 form-group">
                    <label class="control-label">Unit</label>
                    <select
                      class="form-control"
                      v-model="probeData.alarm_time_unit"
                      ref="alarm_time_unit"
                      required
                    >
                      <option value="Seconds">Seconds</option>
                ...
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <select
                      class="form-control"
                      v-model="probeData.default_sensor"
                      ref="default_sensor"
                      required
                    >
                ...
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <select
                      class="form-control"
                      v-model="probeData.is_configured"
                      ref="is_configured"
                      required
                    >
                ...
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <select
                      class="form-control"
                      v-model="probeData.is_monitored"
                      ref="is_monitored"
                      required
                    >
                      <option value="Yes">Yes</option>
                ...
                <div class="row" v-if="probeData.is_monitored=='Yes'">
                  <div class="col-sm-6 form-group">
                    ...
                    <datepicker
                      v-model="probeData.online_monitoring_date"
                      :format="format"
                      input-class="form-control"
                      ref="online_monitoring_date"
                    />
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <select
                      @change="getLocations(probeData.organization_id)"
                      class="form-control"
                      v-model="probeData.organization_id"
                      ref="organization_id"
                      required
                    >
                      <option
              ...
              <div class="col-xs-12 form-group">
                <button class="btn btn-sm btn-success">
                  <i class="icon-fa icon-fa-plus-circle" /> Create
                </button>
              </div>
            </form>
          </div>
...
export default {
  ...
  methods: {
    ...
    getLocations(organization_id) {
      ...
      axios
        .get(
          "/api/admin/locations/getLocationsByOrganizationID/" + organization_id
        )
        .then(function(resp) {
    ...
    saveForm() {
      ...
      axios
        .post("/api/admin/probes", app.probeData)
        .then(function(resp) {
          if (resp.data.status == "error") {
            toastr["error"](
              "Something went wrong while adding the probe. Please contact admin about this.",
              "Error!"
            );
          } else {
