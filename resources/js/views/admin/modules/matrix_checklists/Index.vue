        ...
        <div class="card">
          <div class="card-header">
            <div class="row">
              ...
              <div class="col-sm-6">
                <router-link
                  to="/admin/matrix_checklists/add"
              ...
              >
                ...
                <table-column :sortable="false" :filterable="false" label="Actions">
                  <template slot-scope="row">
                    <a :href="`/admin/matrix_checklists/view/${row.id}`">
  ...
  methods: {
    ...
    getMatrixChecklists: lodash.debounce(function(page = 1) {
      ...
      if (app.filters.start_date > app.filters.end_date) {
        ...
        axios
          .get(
            `/api/admin/matrix_checklists/get?page=${page}&organization_id=${app.filters.organization}&start_date=${app.filters.start_date}&end_date=${app.filters.end_date}`
          )
          .then(function(resp) {
