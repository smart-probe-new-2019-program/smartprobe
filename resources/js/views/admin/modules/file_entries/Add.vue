        ...
        <div class="card">
          <div class="card-header">
            <div class="row">
              ...
              <div class="col-sm-6">
                <router-link to="/admin/file_entries" class="btn btn-dark btn-xs float-right">
			   ...
			   <div class="container">
				   	<div class="row">
						<div class="col-sm-6 form-group">
							...
							<select class="form-control" v-model.trim="organization_id" ref="organization_id" required>
...
export default {
	...
	methods: {
		...
		submitFiles() {
			...
			if(errorCount == 0){
				app.$router.push('/admin/file_entries');
