              ...
              <div class="col-sm-12 form-group">
                <div class="row">
                  ...
                  <div class="col-sm-6 form-group">
                    ...
                    <select
                      class="form-control"
                      @change="getChecklistAreas()"
                      v-model.trim="filters.checklist_area.organization"
                      ref="organization"
                    >
              ...
              >
                ...
                <table-column :sortable="false" :filterable="false" label="Actions">
                  <template slot-scope="row">
                    <a :href="`/admin/checklist_areas/edit/${row.id}`">
          ...
          <div class="card-body">
              ...
              <div class="col-sm-12 form-group">
                <div class="row">
                  ...
                  <div class="col-sm-6 form-group">
                    ...
                    <select
                      class="form-control"
                      @change="getChecklistTimes()"
                      v-model.trim="filters.checklist_time.organization"
                      ref="organization"
                    >
                      <option value="All" selected>All</option>
                      <option
            ...
            <div>
              ...
              >
                ...
                <table-column :sortable="false" :filterable="false" label="Actions">
                  <template slot-scope="row">
                    <a :href="`/admin/checklist_times/edit/${row.id}`">
                      <i class="icon-fa icon-fa-pencil-square-o" />
                    </a>
        ...
        <div class="card">
          <div class="card-header">
            <div class="row">
              ...
              <div class="col-sm-6">
                <router-link
                  to="/admin/checklist_categories/add"
                  class="btn btn-success btn-xs float-right"
                >
          ...
          <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 form-group">
                    ...
                    <select
                      ...
                      v-model.trim="filters.checklist_category.organization"
                      ref="organization"
                    >
                      <option value="All" selected>All</option>
                      <option
            ...
            <div>
              ...
              >
                ...
                <table-column :sortable="false" :filterable="false" label="Actions">
                  <template slot-scope="row">
                    <a :href="`/admin/checklist_categories/edit/${row.id}`">
                      <i class="icon-fa icon-fa-pencil-square-o" />
                    </a>
          ...
          <div class="card-body">
              ...
              <div class="col-sm-12 form-group">
                <div class="row">
                  ...
                  <div class="col-sm-6 form-group">
                    ...
                    <select
                      class="form-control"
                      @change="getChecklistItems()"
                      v-model.trim="filters.checklist_item.organization"
                      ref="organization"
                    >
                      <option value="All" selected>All</option>
                      <option
            ...
            <div>
              ...
              >
                ...
                <table-column :sortable="false" :filterable="false" label="Actions">
                  <template slot-scope="row">
                    <a :href="`/admin/checklist_items/edit/${row.id}`">
                      <i class="icon-fa icon-fa-pencil-square-o" />
                    </a>
...
export default {
  ...
  data() {
    return {
      ...
      organizations: [],
      filters: {
        checklist_area: { keyword: null, organization: "All" },
        checklist_time: { keyword: null, organization: "All" },
        checklist_category: { keyword: null, organization: "All" },
        checklist_item: { keyword: null, organization: "All" }
      }
    };
  },
  mounted() {
