				...
				<div class="panel-body">
					<div class="row">
						<div class="col-sm-6 form-group">
							...
							<select class="form-control" v-model.trim="checklistCategoriesData.organization_id" ref="organization_id" required>
...
export default {
	...
	methods: {
		...
		saveForm() {
			...
			axios.post('/api/admin/checklist_categories', app.checklistCategoriesData)
			.then(function(resp) {
