        ...
        <div class="card">
          <div class="card-header">
            <div class="row">
              ...
              <div class="col-sm-6">
                <router-link to="/admin/incoming_deliveries_type_of_products" class="btn btn-dark btn-xs float-right">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-sm-6 form-group">
							...
							<select class="form-control" v-model.trim="typeOfProductData.organization_id" ref="organization_id" required>
...
export default {
	...
	methods: {
		...
		saveForm() {
			...
			axios.post('/api/admin/id_type_of_products', app.typeOfProductData)
			.then(function(resp) {
				if(resp.data.status == 'error'){
					toastr['error']('Something went wrong while adding the type. Please contact admin about this.', 'Error!');
				}
				else{
					app.$router.push('/admin/incoming_deliveries_type_of_products');
