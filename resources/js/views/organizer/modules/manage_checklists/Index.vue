        ...
        <div class="card">
          <div class="card-header">
            <div class="row">
              ...
              <div class="col-sm-6">
                <router-link
                  to="/organizer/manage_checklists/add"
              ...
              >
                ...
                <table-column :sortable="false" :filterable="false" label="Actions">
                  <template slot-scope="row">
                    <a :href="`/organizer/manage_checklists/view/${row.id}`">
                      <i class="icon-fa icon-fa-eye" />
                    </a>
                    <a :href="`/organizer/manage_checklists/edit/${row.id}`">
...
export default {
  ...
  methods: {
    getChecklists: lodash.debounce(function(page = 1) {
      ...
      axios
        .get(
          `/api/admin/manage_checklists/getManageChecklistsForOrganizer?page=${page}&organization_id=${app.filters.organization}&filter_type=${app.filters.type}&filter_keyword=${app.filters.keyword}`
        )
        .then(function(resp) {
