				...
				<div class="card">
					<div class="card-header">
						<div class="row">
							...
							<div class="col-sm-6">
								<router-link to="/organizer/checklist_areas/add" class="btn btn-success btn-xs float-right"><i class="icon-fa icon-fa-plus-circle"/>Add Area</router-link>
							</div>
						</div>  
					</div>
					<div class="card-body">
						<table-component :data="fetchChecklistsAreaData" :show-filter="false" filter-placeholder="Search areas.." filter-no-results="No areas found!" table-class="table" ref="checklistAreaTable">
							...
							<table-column :sortable="false" :filterable="false" label="Actions">
								<template slot-scope="row">
									<a :href="`/organizer/checklist_areas/edit/${row.id}`"><i class="icon-fa icon-fa-pencil-square-o"/></a>
				...
				<div class="card">
					<div class="card-header">
						<div class="row">
							...
							<div class="col-sm-6">
								<router-link to="/organizer/checklist_times/add" class="btn btn-success btn-xs float-right"><i class="icon-fa icon-fa-plus-circle"/>Add Time</router-link>
							</div>
						</div>  
					</div>
					<div class="card-body">
						<table-component :data="fetchChecklistsTimeData" :show-filter="false" filter-placeholder="Search times.." filter-no-results="No times found!" table-class="table" ref="checklistTimeTable">
							...
							<table-column :sortable="false" :filterable="false" label="Actions">
								<template slot-scope="row">
									<a :href="`/organizer/checklist_times/edit/${row.id}`"><i class="icon-fa icon-fa-pencil-square-o"/></a>
				...
				<div class="card">
					<div class="card-header">
						<div class="row">
							...
							<div class="col-sm-6">
								<router-link to="/organizer/checklist_categories/add" class="btn btn-success btn-xs float-right"><i class="icon-fa icon-fa-plus-circle"/>Add Category</router-link>
							</div>
						</div>  
					</div>
					<div class="card-body">
						<table-component :data="fetchChecklistsCategoryData" :show-filter="false" filter-placeholder="Search categories.." filter-no-results="No categories found!" table-class="table" ref="checklistCategoryTable">
							...
							<table-column :sortable="false" :filterable="false" label="Actions">
								<template slot-scope="row">
									<a :href="`/organizer/checklist_categories/edit/${row.id}`"><i class="icon-fa icon-fa-pencil-square-o"/></a>
				...
				<div class="card">
					<div class="card-header">
						<div class="row">
							...
							<div class="col-sm-6">
								<router-link to="/organizer/checklist_items/add" class="btn btn-success btn-xs float-right"><i class="icon-fa icon-fa-plus-circle"/>Add Item</router-link>
							</div>
						</div>  
					</div>
					<div class="card-body">
						<table-component :data="fetchChecklistsItemData" :show-filter="false" filter-placeholder="Search items.." filter-no-results="No items found!" table-class="table" ref="checklistItemTable">
							...
							<table-column :sortable="false" :filterable="false" label="Actions">
								<template slot-scope="row">
									<a :href="`/organizer/checklist_items/edit/${row.id}`"><i class="icon-fa icon-fa-pencil-square-o"/></a>
...
export default {
  ...
  methods: {
    ...
    async fetchChecklistsAreaData ({ page, filter, sort }) {
      const response = await axios.get(`/api/admin/checklist_areas/get?page=${page}&organization_id=${this.organization_id}`)
	...
	async fetchChecklistsTimeData ({ page, filter, sort }) {
      const response = await axios.get(`/api/admin/checklist_times/get?page=${page}&organization_id=${this.organization_id}`)
	...
	async fetchChecklistsCategoryData ({ page, filter, sort }) {
      const response = await axios.get(`/api/admin/checklist_categories/get?page=${page}&organization_id=${this.organization_id}`)
	...
	async fetchChecklistsItemData ({ page, filter, sort }) {
      const response = await axios.get(`/api/admin/checklist_items/get?page=${page}&organization_id=${this.organization_id}`)
