        ...
        <div class="card">
          <div class="card-header">
            <div class="row">
              ...
              <div class="col-sm-6">
                <router-link to="/manager/probes/add" class="btn btn-success btn-xs float-right">
              ...
              >
                ...
                <table-column :sortable="false" :filterable="false" label="Actions">
                  <template slot-scope="row">
                    <a :href="`/manager/probes/view/${row.id}`">
                      <i class="icon-fa icon-fa-eye" />
                    </a>
                    <a :href="`/manager/probes/edit/${row.id}`">
...
export default {
  ...
  methods: {
    getProbes: lodash.debounce(function(page = 1) {
      ...
      axios
        .get(
          `/api/admin/probes/get?page=${page}&organization_id=${app.filters.organization}&location_id=${app.filters.location_id}&filter_keyword=${app.filters.keyword}&filter_status=${app.filters.status}`
        )
        .then(function(resp) {
