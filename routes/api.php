...
Route::group(['prefix' => 'admin', 'middleware' => 'api.auth'], function () {
	...
	//Alarm Logs
	Route::resource('alarm_logs', 'AlarmLogsController', ['except' => ['create', 'edit']]);

	/** ------------------------------------------------------------------------------------------------------------------------- **/

	//Contacts
	Route::get('contacts/get', [
		'as' => 'admin.contacts', 'uses' => 'ContactsController@getAllContacts'
	]);

	Route::get('contacts/getContactsByLocation', [
		'as' => 'admin.contacts.getContactsByLocation', 'uses' => 'ContactsController@getContactsByLocation'
	]);

	Route::get('contacts/getContact/{id}', [
		'as' => 'admin.contacts.getContact', 'uses' => 'ContactsController@getContact'
	]);
	...
	Route::get('corrective_actions/getTempCheckLogs', [
		'as' => 'admin.corrective_actions.getTempCheckLogs', 'uses' => 'CorrectiveActionsController@getTempCheckLogs'
	]);
